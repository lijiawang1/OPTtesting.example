...
eig = eigs_sym(Sigma, 999, which = "LM")
eig_value = 0.4 #0.12 #the smallest eigen values used in the calculation
...
colMeans(results)
# > colMeans(results)
# [1] 722.3900000   0.1007248   0.1818893   0.0369734
...
colMeans(results_1)
# > colMeans(results_1)
# [1]  0.01219713  0.68246090 85.33000000
...
colMeans(results_1)
# > colMeans(results_1)
# [1]   0.02552011   0.62359980 227.32000000
...
colMeans(results_1)
# > colMeans(results_1)
# [1] 5.819379e-04 6.197700e-01 2.243200e+02
