...
eig = eigs_sym(Sigma, 999, which = "LM")
eig_value = 0.05#0.12 #the smallest eigen values used in the calculation
...
# > colMeans(results)
# [1] 707.04000000   0.09419194   0.20886382   0.15940415
...
colMeans(results_1)
# > colMeans(results_1)
# [1]  0.01308382  0.68132948 89.01000000
...
for (i in 1:Bj_time ){
  ...
  select_p = which(qvalue(p_value ,lambda = seq(0, 0.8,0.1) )$qvalue <0.1)
  ui = ui_sets[,i]
...
colMeans(results_1)
# > colMeans(results_1)
# [1]   0.0265891   0.6224995 239.0600000
...
colMeans(results_1)
# > colMeans(results_1)
# [1] 5.517760e-04 6.028005e-01 2.448700e+02
